...
if ('C:\Users\computing\Desktop\Advanced-Graphics\XAMPP\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\computing\Desktop\Advanced-Graphics\XAMPP\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
